            ...
            <div class="relative fade-in">
                <div class="relative aspect-square rounded-3xl overflow-hidden shadow-2xl">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-8 text-white">
                        <div class="text-center">
                            <div
                                class="w-16 h-16 mx-auto mb-4 bg-gradient-primary rounded-full flex items-center justify-center shadow-lg backdrop-blur-sm">
                ...
                <div class="absolute -bottom-4 -left-4 w-12 h-12 bg-gradient-accent rounded-full opacity-80 animate-pulse"
                    style="animation-delay: 1s;"></div>
                <div class="absolute top-1/2 -left-8 w-8 h-8 bg-gradient-primary rounded-full opacity-60 animate-pulse"
                    style="animation-delay: 0.5s;"></div>
                <div class="absolute bottom-1/4 -right-6 w-6 h-6 bg-gradient-secondary rounded-full opacity-70 animate-pulse"
                    style="animation-delay: 1.5s;"></div>

                <!-- Additional Aesthetic Elements -->
                <div class="absolute top-8 left-8 w-4 h-4 bg-white/30 rounded-full animate-pulse"
                    style="animation-delay: 2s;"></div>
                <div class="absolute bottom-8 right-8 w-3 h-3 bg-purple-400/40 rounded-full animate-pulse"
