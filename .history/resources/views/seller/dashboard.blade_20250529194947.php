        ...
        <div class="flex flex-col lg:flex-row items-center justify-between">
            ...
            <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 relative z-20">
                <a href="{{ route('seller.products.create') }}" id="hero-add-product-btn"
                    class="gradient-secondary text-white px-6 py-3 rounded-full font-semibold hover:shadow-lg hover:scale-105 transition-all duration-200 flex items-center space-x-2 shadow-modern cursor-pointer relative z-30">
                ...
                <a href="{{ route('seller.products.index') }}" id="hero-manage-products-btn"
                    class="border-2 border-white/30 text-white px-6 py-3 rounded-full font-semibold hover:bg-white/10 transition-all duration-200 flex items-center space-x-2 backdrop-blur-sm cursor-pointer relative z-30">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
