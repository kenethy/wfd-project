                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="images"
                                        ...
                                        <input id="images" name="images[]" type="file" class="sr-only" multiple
                                            accept="image/*" onchange="previewImages(this)" required>
                                    </label>
...
<script>
    function previewImages(input) {
        ...
        alert('Function called! Files: ' + (input.files ? input.files.length : 0));
        const preview = document.getElementById('imagePreview');
        preview.innerHTML = '';

        if (input.files && input.files.length > 0) {
            console.log('Files found:', input.files.length);
