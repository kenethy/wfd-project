...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <form method="POST" action="{{ route('seller.products.update', $product) }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="px-6 py-6 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            @php
                                $availableSizes = ['XS', 'S', 'M', 'L', 'XL', 'XXL', '28', '29', '30', '31', '32', '33', '34'];
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            @php
                                $availableColors = ['White', 'Black', 'Gray', 'Navy', 'Blue', 'Red', 'Pink', 'Green', 'Yellow', 'Purple'];
            ...
            <!-- New Images -->
            <div class="px-6 py-6">
                <h2 class="text-xl font-bold text-gray-900 mb-6">{{ $product->images && count($product->images) > 0 ? 'Replace Images' : 'Product Images' }}</h2>
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-blue-400 transition-colors">
                            <div class="space-y-1 text-center">
                                ...
                                <p class="text-xs text-gray-500">PNG, JPG, GIF up to 2MB (max 5 images)</p>
                            </div>
                        </div>
                        @error('images.*')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
