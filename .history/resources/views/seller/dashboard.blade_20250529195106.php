...
<div class="bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="flex flex-col lg:flex-row items-center justify-between">
            ...
            <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 relative z-20">
                <!-- Add Product Button -->
                <div class="relative z-30">
                    <a href="{{ route('seller.products.create') }}" id="hero-add-product-btn"
                        class="gradient-secondary text-white px-6 py-3 rounded-full font-semibold hover:shadow-lg hover:scale-105 transition-all duration-200 flex items-center space-x-2 shadow-modern cursor-pointer inline-flex no-underline"
                ...
                <div class="relative z-30">
                    <a href="{{ route('seller.products.index') }}" id="hero-manage-products-btn"
                        class="border-2 border-white/30 text-white px-6 py-3 rounded-full font-semibold hover:bg-white/10 transition-all duration-200 flex items-center space-x-2 backdrop-blur-sm cursor-pointer inline-flex no-underline"
                        style="pointer-events: auto; z-index: 9999; position: relative;">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <!-- Fallback Buttons (Simple HTML) -->
            <div class="mt-4 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                <button onclick="navigateToCreateProduct()"
                    class="bg-pink-500 hover:bg-pink-600 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 cursor-pointer">
                    Quick Add Product
                </button>
                <button onclick="navigateToManageProducts()"
                    class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 cursor-pointer">
                    Quick Manage Products
                </button>
            </div>
        </div>
    </div>
            ...
            <div class="flex items-center justify-between">
                <div class="space-y-2">
                    <div class="flex items-center space-x-2">
                        ...
                        <p class="text-slate-600 text-sm font-semibold">Total Products</p>
                    </div>
                    <p class="text-3xl font-bold text-slate-800">{{ $totalProducts }}</p>
                    <p class="text-sm text-emerald-600 font-medium">{{ $activeProducts }} active products</p>
                </div>
                <div
            ...
            <div class="flex items-center justify-between">
                <div class="space-y-2">
                    <div class="flex items-center space-x-2">
                        ...
                        <p class="text-slate-600 text-sm font-semibold">Total Orders</p>
                    </div>
                    <p class="text-3xl font-bold text-slate-800">{{ $totalOrders }}</p>
                    <p class="text-sm text-emerald-600 font-medium">All time</p>
                </div>
                <div
            ...
            <div class="flex items-center justify-between">
                <div class="space-y-2">
                    <div class="flex items-center space-x-2">
                        ...
                        <p class="text-slate-600 text-sm font-semibold">Total Revenue</p>
                    </div>
                    <p
            ...
            <div class="flex items-center justify-between">
                <div class="space-y-2">
                    <div class="flex items-center space-x-2">
                        ...
                        <p class="text-slate-600 text-sm font-semibold">Low Stock</p>
                    </div>
                    <p class="text-3xl font-bold text-slate-800">{{ $lowStockProducts }}</p>
                    <p class="text-sm text-red-500 font-medium">Needs attention</p>
                </div>
                <div
    ...
    <div class="mt-8 bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-500 rounded-2xl shadow-xl p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <a href="{{ route('seller.products.index') }}"
                class="group bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl text-white text-decoration-none block">
                <div class="text-center">
                    <div
                        class="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-white/30 transition-all duration-300">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M20 7l-8-4-8 4m16 0l-8 4-8-4m16 0v10l-8 4-8-4V7"></path>
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold text-white mb-2">Manage Products</h3>
                    <p class="text-white/80 text-sm leading-relaxed">Manage your product catalog</p>
                </div>
            </a>
            ...
            <a href="{{ route('seller.orders.index') }}"
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-bold text-white mb-2">Manage Orders</h3>
                    <p class="text-white/80 text-sm leading-relaxed">Process customer orders</p>
                </div>
            </a>
            ...
            <a href="{{ route('seller.orders.analytics') }}"
                ...
                <div class="text-center">
                    ...
                    <p class="text-white/80 text-sm leading-relaxed">View sales performance</p>
                </div>
            </a>
            ...
            <a href="{{ route('seller.products.create') }}"
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-bold text-white mb-2">Add Product</h3>
                    <p class="text-white/80 text-sm leading-relaxed">Create new listing</p>
                </div>
            </a>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // === HERO SECTION BUTTONS DEBUG ===
        const heroAddBtn = document.getElementById('hero-add-product-btn');
        const heroManageBtn = document.getElementById('hero-manage-products-btn');

        console.log('🎯 Hero Add Product Button:', heroAddBtn);
        console.log('🎯 Hero Manage Products Button:', heroManageBtn);

        if (heroAddBtn) {
            console.log('✅ Hero Add Product Button found:', heroAddBtn.href);

            // Ensure button is clickable
            heroAddBtn.style.pointerEvents = 'auto';
            heroAddBtn.style.cursor = 'pointer';
            heroAddBtn.style.zIndex = '9999';

            // Add click event
            heroAddBtn.addEventListener('click', function (e) {
                console.log('🔥 HERO ADD PRODUCT CLICKED!', this.href);
            ...
            // Add hover effects
            heroAddBtn.addEventListener('mouseenter', function () {
                console.log('🎯 Hero Add Product Button hovered');
                this.style.transform = 'scale(1.05)';
            });

            heroAddBtn.addEventListener('mouseleave', function () {
                this.style.transform = '';
            });
        } else {
            console.error('❌ Hero Add Product Button NOT FOUND!');
        }

        if (heroManageBtn) {
            console.log('✅ Hero Manage Products Button found:', heroManageBtn.href);

            // Ensure button is clickable
            heroManageBtn.style.pointerEvents = 'auto';
            heroManageBtn.style.cursor = 'pointer';
            heroManageBtn.style.zIndex = '9999';

            // Add click event
            heroManageBtn.addEventListener('click', function (e) {
                console.log('🔥 HERO MANAGE PRODUCTS CLICKED!', this.href);
            ...
            // Add hover effects
            heroManageBtn.addEventListener('mouseenter', function () {
                console.log('🎯 Hero Manage Products Button hovered');
                this.style.transform = 'scale(1.05)';
            });

            heroManageBtn.addEventListener('mouseleave', function () {
                this.style.transform = '';
            });
        } else {
            console.error('❌ Hero Manage Products Button NOT FOUND!');
        }
        ...
        quickActionLinks.forEach((link, index) => {
            ...
            // Add click event listener (only for non-hero buttons)
            if (!link.id || (!link.id.includes('hero-'))) {
                link.addEventListener('click', function (e) {
                    console.log('🔗 Quick Action Link clicked:', this.href);
        ...
        console.log('Add Product Route:', '{{ route("seller.products.create") }}');
        console.log('Manage Products Route:', '{{ route("seller.products.index") }}');
    });

    // === FALLBACK NAVIGATION FUNCTIONS ===
    function navigateToCreateProduct() {
        console.log('🚀 Fallback: Navigating to Create Product');
        window.location.href = '{{ route("seller.products.create") }}';
    }

    function navigateToManageProducts() {
        console.log('🚀 Fallback: Navigating to Manage Products');
