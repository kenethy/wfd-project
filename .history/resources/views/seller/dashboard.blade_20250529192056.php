...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    ...
    <!-- Quick Actions -->
    <div class="mt-8 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg shadow-lg p-6">
        <h2 class="text-xl font-bold mb-4 text-white">Quick Actions</h2>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <a href="{{ route('seller.products.index') }}"
                class="bg-white bg-opacity-20 rounded-lg p-4 hover:bg-opacity-30 transition-all duration-200 hover:scale-105 text-white hover:text-white group">
                <svg class="w-8 h-8 mb-2 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M20 7l-8-4-8 4m16 0l-8 4-8-4m16 0v10l-8 4-8-4V7"></path>
                </svg>
                <h3 class="font-medium text-white">Manage Products</h3>
                <p class="text-sm text-white opacity-90">Add, edit, delete products</p>
            </a>
            ...
            <a href="{{ route('seller.orders.index') }}"
                ...
                <h3 class="font-medium text-white">Manage Orders</h3>
                <p class="text-sm text-white opacity-90">Process and ship orders</p>
            </a>
            ...
            <a href="{{ route('seller.orders.analytics') }}"
                ...
                <p class="text-sm text-white opacity-90">View performance metrics</p>
            </a>
            ...
            <a href="{{ route('seller.products.create') }}"
                ...
                <h3 class="font-medium text-white">Add Product</h3>
                <p class="text-sm text-white opacity-90">Create new listing</p>
            </a>
        </div>
    </div>
</div>
