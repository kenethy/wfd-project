...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    ...
    <div class="mt-8 bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-500 rounded-2xl shadow-xl p-8">
        <div class="text-center mb-8">
            <h2 class="text-3xl font-bold text-white mb-2">⚡ Quick Actions</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- Manage Products -->
            <a href="{{ route('seller.products.index') }}"
                class="group relative bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl block">
                ...
                <div
                    class="absolute inset-0 bg-gradient-to-r from-blue-400/20 to-purple-400/20 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                </div>
            </a>
            ...
            <a href="{{ route('seller.orders.index') }}"
                ...
                <div class="text-center relative z-10">
                    ...
                    <h3 class="text-xl font-bold text-white mb-2">🛒 Orders</h3>
                    <p class="text-white/80 text-sm leading-relaxed">Process customer orders</p>
                </div>
                <div
                    class="absolute inset-0 bg-gradient-to-r from-green-400/20 to-blue-400/20 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                </div>
            </a>
            ...
            <a href="{{ route('seller.orders.analytics') }}"
                ...
                <div
                    class="absolute inset-0 bg-gradient-to-r from-yellow-400/20 to-orange-400/20 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                </div>
            </a>
            ...
            <a href="{{ route('seller.products.create') }}"
                ...
                <div
                    class="absolute inset-0 bg-gradient-to-r from-pink-400/20 to-purple-400/20 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                </div>
            </a>
        </div>
...
<script>
    // Ensure Quick Action links are working
    document.addEventListener('DOMContentLoaded', function () {
        // Add click handlers to Quick Action links for debugging
        const quickActionLinks = document.querySelectorAll('.grid a[href*="seller/products"]');
