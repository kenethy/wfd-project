                        ...
                        <div class="flex-1 bg-gray-200 rounded-full h-6 relative">
                            ...
                            <div class="bg-gradient-to-r from-blue-500 to-blue-600 h-6 rounded-full transition-all duration-500 ease-out flex items-center justify-end pr-2" 
                                ...
                                @if($monthData['sales'] > 0)
                                    <span class="text-white text-xs font-medium">Rp {{ number_format($monthData['sales'] / 1000, 0) }}K</span>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="w-8 h-8 rounded-full flex items-center justify-center
                                ...
                                @if($activity['icon'] === 'shopping-cart')
                                    <svg class="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-1.5 6M7 13l1.5-6m0 0L4 5M7 13h10m0 0l1.5 6M17 13l1.5-6"></path>
                                    </svg>
                                @else
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="space-y-4">
                @forelse($topProducts as $index => $product)
                    <div class="flex items-center space-x-4">
                        <div class="flex-shrink-0">
                            <div class="w-8 h-8 rounded-full bg-gradient-to-r from-yellow-400 to-yellow-500 flex items-center justify-center">
                        ...
                        <div class="text-right">
                            <p class="text-sm font-medium text-gray-900">Rp {{ number_format($product->total_revenue, 0, ',', '.') }}</p>
                        </div>
                    </div>
                @empty
                    <div class="text-center py-8">
