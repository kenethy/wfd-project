        ...
        <form id="bulkActionForm" method="POST" action="{{ route('seller.orders.bulk-update-status') }}">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex items-center space-x-4">
                    ...
                    <select name="status" class="px-4 py-2 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500">
    ...
    @else
        ...
        <div class="text-center py-20">
            <div class="max-w-lg mx-auto">
                ...
                <p class="text-xl text-slate-600 mb-8">Orders for your products will appear here once customers start purchasing.</p>
