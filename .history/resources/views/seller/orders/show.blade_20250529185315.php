                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center space-x-4 p-4 bg-slate-50 rounded-xl">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-sm text-slate-600">Unit: Rp {{ number_format($item->price, 0, ',', '.') }}</p>
                            <p class="text-lg font-bold text-slate-900">Rp {{ number_format($item->price * $item->quantity, 0, ',', '.') }}</p>
                        </div>
                    </div>
                    @endforeach
                </div>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 sticky top-4">
                    ...
                    <div class="border-t border-slate-200 pt-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-2xl font-bold text-slate-900">
                                Rp {{ number_format($sellerOrderItems->sum(function($item) { return $item->price * $item->quantity; }), 0, ',', '.') }}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 pt-6 border-t border-slate-200 text-center">
                    ...
                    <a href="mailto:{{ $order->user->email }}" class="text-purple-600 hover:text-purple-700 font-medium text-sm">
                        Send Email
                    </a>
                </div>
            </div>
            ...
            <form id="statusForm" method="POST">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <select name="status" id="statusSelect" class="w-full px-4 py-2 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="tracking_number" class="w-full px-4 py-2 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Enter tracking number">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-2">Notes (Optional)</label>
                        <textarea name="notes" rows="3" class="w-full px-4 py-2 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Add any notes about this status update"></textarea>
                    </div>
                </div>
                <div class="flex space-x-3 mt-6">
                    <button type="submit" class="flex-1 gradient-primary text-white py-2 px-4 rounded-xl font-medium hover:shadow-lg transition-all duration-200">
                        Update Status
                    </button>
                    <button type="button" onclick="closeStatusModal()" class="flex-1 bg-slate-100 text-slate-700 py-2 px-4 rounded-xl font-medium hover:bg-slate-200 transition-colors duration-200">
                        Cancel
                    </button>
                </div>
            </form>
