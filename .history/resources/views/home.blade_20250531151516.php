...
<div class="bg-gradient-to-r from-slate-900 to-purple-900 py-20 relative overflow-hidden">
    ...
    <div class="absolute inset-0">
        <div class="absolute top-10 left-10 w-20 h-20 bg-gradient-secondary rounded-full opacity-20 animate-float-slow"></div>
        <div class="absolute top-1/2 right-20 w-16 h-16 bg-gradient-accent rounded-full opacity-30 animate-float"></div>
        <div class="absolute bottom-20 left-1/4 w-12 h-12 bg-gradient-primary rounded-full opacity-25 animate-float-slow"></div>
        <div class="absolute top-1/4 right-1/3 w-8 h-8 bg-gradient-secondary rounded-full opacity-40 animate-float"></div>
    </div>
