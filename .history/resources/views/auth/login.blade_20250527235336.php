...
@section('title', 'Login - WFD Marketplace')
            ...
            <div class="mt-6 border-t border-gray-200 pt-6">
                ...
                <div class="space-y-2 text-xs text-gray-600">
                    <div class="bg-gray-50 p-2 rounded">
                        <strong>Admin:</strong> admin@wfd.com / password
                    </div>
                    <div class="bg-gray-50 p-2 rounded">
                        <strong>Seller:</strong> seller1@wfd.com / password
                    </div>
                    <div class="bg-gray-50 p-2 rounded">
                        <strong>Customer:</strong> customer1@wfd.com / password
                    </div>
                </div>
            </div>
        </form>
