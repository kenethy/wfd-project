        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative fade-in">
                ...
                <div
                    ...
                    <!-- Background Image -->
                    <img src="{{ asset('storage/images/aesthetichome.jpg') }}" alt="Premium Fashion Collection"
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-4 sm:p-6 lg:p-8 text-white">
                        <div class="text-center">
                            ...
                            <div
                                ...
                                <span class="text-white text-lg sm:text-2xl font-bold">F</span>
                            </div>
                            <h3 class="text-xl sm:text-2xl font-bold mb-1 sm:mb-2">Premium Fashion</h3>
                            <p class="text-slate-200 text-base sm:text-lg">Curated for You</p>

                            <!-- Quality Indicators -->
                            <div class="flex justify-center items-center space-x-2 sm:space-x-4 mt-3 sm:mt-4">
                                <div class="flex items-center space-x-1">
                                    <span class="text-yellow-400 text-sm">⭐</span>
                                    <span class="text-xs sm:text-sm">Premium</span>
                                </div>
                                <div class="flex items-center space-x-1">
                                    <span class="text-green-400 text-sm">✓</span>
                                    <span class="text-xs sm:text-sm">Authentic</span>
                                </div>
                                <div class="flex items-center space-x-1">
                                    <span class="text-blue-400 text-sm">🚀</span>
                                    <span class="text-xs sm:text-sm">Trending</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div
                    class="absolute -top-4 -right-4 w-16 h-16 bg-gradient-secondary rounded-full opacity-80 animate-float-slow shadow-lg">
                </div>
                <div
                    class="absolute -bottom-4 -left-4 w-12 h-12 bg-gradient-accent rounded-full opacity-80 animate-float shadow-lg">
                </div>
                <div
                    class="absolute top-1/2 -left-8 w-8 h-8 bg-gradient-primary rounded-full opacity-60 animate-float-slow shadow-lg">
                </div>
                <div
                    class="absolute bottom-1/4 -right-6 w-6 h-6 bg-gradient-secondary rounded-full opacity-70 animate-float shadow-lg">
                </div>

                <!-- Additional Floating Elements for More Dynamic Look -->
                <div class="absolute top-1/4 right-1/4 w-4 h-4 bg-white rounded-full opacity-50 animate-float"></div>
                <div
                    class="absolute bottom-1/3 left-1/3 w-3 h-3 bg-purple-300 rounded-full opacity-60 animate-float-slow">
                </div>
            </div>
        </div>
    </div>
