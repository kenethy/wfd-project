    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative fade-in">
                ...
                <div
                    class="relative aspect-square rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 group">
                    <!-- Background Image -->
                    <img src="{{ asset('images/aesthethichome.jpg') }}" alt="Premium Fashion Collection"
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-8 text-white">
                        <div class="text-center">
                            <!-- Brand Badge -->
                            <div
                                class="inline-flex items-center justify-center w-16 h-16 bg-gradient-primary rounded-full shadow-lg mb-4 hover:scale-110 transition-transform duration-300">
                                <span class="text-white text-2xl font-bold">F</span>
                            </div>
                            <h3 class="text-2xl font-bold mb-2">Premium Fashion</h3>
                            <p class="text-slate-200 text-lg">Curated for You</p>
