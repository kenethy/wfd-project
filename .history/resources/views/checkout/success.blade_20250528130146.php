...
<div class="bg-gradient-to-r from-emerald-50 to-green-50 border-b border-emerald-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="text-center">
            ...
            <p class="text-xl text-slate-600 mb-6">Thank you for your purchase. Your order has been successfully placed.
            </p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
                ...
                <div class="flex items-center space-x-4 p-6 bg-emerald-50 rounded-xl border border-emerald-200">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-emerald-600 mt-1">Placed on {{ $order->created_at->format('F j, Y \a\t
                            g:i A') }}</p>
                    </div>
                </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-600">We'll prepare your items for shipment (1-2 business
                                    days)</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-600">Your order will be shipped to your address (3-5
                                    business days)</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-3">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
                ...
                <div class="bg-slate-50 rounded-xl p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h3 class="text-lg font-semibold text-slate-900 mb-2">{{ $shippingAddress['full_name'] }}
                            </h3>
                        ...
                        <div>
                            ...
                            <p class="text-slate-600">{{ $shippingAddress['city'] }}, {{ $shippingAddress['postal_code']
                                }}</p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 sticky top-4">
                ...
                <div class="space-y-4 mb-8">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="font-semibold text-slate-900">Rp {{ number_format($order->total_amount, 0, ',',
                            '.') }}</span>
                    </div>
                    ...
                    <div class="border-t border-slate-200 pt-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-2xl font-bold text-slate-900">Rp {{ number_format($order->total_amount, 0,
                                ',', '.') }}</span>
                        </div>
                    </div>
                </div>
