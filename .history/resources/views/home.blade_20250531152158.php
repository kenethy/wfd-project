            ...
            <div class="text-white space-y-8 fade-in">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="{{ route('products.index') }}"
                        class="bg-white text-slate-900 px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 text-center shadow-modern hover:bg-slate-50">
                        Shop Collection
                    </a>
                    <a href="#featured"
                        ...
                        <div class="text-center">
                            ...
                            <div class="flex justify-center items-center space-x-2 sm:space-x-4 mt-3 sm:mt-4">
                                <div class="flex items-center space-x-1">
                                    ...
                                    <span class="text-xs sm:text-sm drop-shadow-md">Premium</span>
                                </div>
                                <div class="flex items-center space-x-1">
                                    <span class="text-green-400 text-sm drop-shadow-md">✓</span>
                                    <span class="text-xs sm:text-sm drop-shadow-md">Authentic</span>
                                </div>
                                <div class="flex items-center space-x-1">
                                    <span class="text-blue-400 text-sm drop-shadow-md">🚀</span>
                                    <span class="text-xs sm:text-sm drop-shadow-md">Trending</span>
                                </div>
                            </div>
                        </div>
                    </div>
