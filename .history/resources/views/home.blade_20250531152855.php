...
<div class="bg-gradient-to-r from-slate-900 to-purple-900 py-20 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center scroll-animate stagger-3">
            ...
            <a href="#featured"
                class="bg-white bg-opacity-10 backdrop-blur-sm  border border-white border-opacity-20 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-opacity-20 transition-all duration-300 btn-animate hover-lift">
                Learn More
            </a>
        </div>
