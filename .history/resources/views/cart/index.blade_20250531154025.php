...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="text-center py-20">
        <div class="max-w-lg mx-auto">
            ...
            <h2 class="text-3xl font-bold text-slate-900 mb-4">Your Cart is Empty</h2>
            <p class="text-xl text-slate-600 mb-8">Discover amazing products and start building your perfect collection.
            </p>
