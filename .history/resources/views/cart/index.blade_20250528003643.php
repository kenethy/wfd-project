...
@section('title', 'Keranjang Belanja - WFD Marketplace')
                ...
                <div class="bg-white rounded-lg shadow-md p-6 sticky top-4">
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <button class="px-4 py-2 bg-gray-100 text-gray-700 rounded-md text-sm font-medium hover:bg-gray-200">
                                Terapkan
                            </button>
                        </div>
                    </div>
        ...
        <div class="text-center py-16">
            <div class="max-w-md mx-auto">
                <svg class="mx-auto h-24 w-24 text-gray-400 mb-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-1.5 6M7 13l1.5-6m0 0L4 5M7 13h10m0 0l1.5 6M17 13l1.5-6"></path>
                </svg>
