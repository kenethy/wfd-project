...
<div class="bg-white border-b border-slate-200 sticky top-16 z-40">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <form method="GET" action="{{ route('products.index') }}" class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0 lg:space-x-6">
            ...
            <div class="flex flex-wrap items-center space-x-4">
                <!-- Category Filter -->
                <select name="category" class="px-4 py-3 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white">
                ...
                <!-- Sort -->
                <select name="sort" class="px-4 py-3 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white">
                ...
                <!-- Filter Button -->
                <button type="submit" class="gradient-primary text-white px-6 py-3 rounded-xl font-medium hover:shadow-lg transition-all duration-200">
                    Apply Filters
                </button>

                <!-- Clear Filters -->
                @if(request()->hasAny(['search', 'category', 'min_price', 'max_price', 'sort']))
                <a href="{{ route('products.index') }}" class="text-slate-600 hover:text-purple-600 px-4 py-3 border border-slate-300 rounded-xl hover:border-purple-300 transition-colors duration-200">
                    Clear All
                </a>
                @endif
            </div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        ...
        <div class="group bg-white rounded-2xl shadow-sm overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-slate-100">
            <!-- Product Image -->
    ...
    <div class="text-center py-20">
        <div class="max-w-md mx-auto">
            ...
            <p class="text-slate-600 mb-6">Try adjusting your search criteria or browse our categories to find what you're looking for.</p>
