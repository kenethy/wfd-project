...
<!-- FACIONA REDESIGN MARKER - This confirms the new design is loading -->
...
<script>
    function changeMainImage(src, element) {
        ...
        document.querySelectorAll('.flex-shrink-0 img').forEach(img => {
            img.classList.remove('border-purple-500', 'ring-2', 'ring-purple-200');
            img.classList.add('border-slate-200');
        });

        // Add active class to clicked thumbnail
        element.classList.remove('border-slate-200');
        element.classList.add('border-purple-500', 'ring-2', 'ring-purple-200');
    }
        ...
        document.querySelectorAll('input[name="size"]').forEach(input => {
            input.addEventListener('change', function () {
                document.querySelectorAll('.size-option').forEach(div => {
                    div.classList.remove('bg-purple-600', 'text-white', 'border-purple-600', 'ring-2', 'ring-purple-200');
                    div.classList.add('border-slate-200');
                });
                this.nextElementSibling.classList.add('bg-purple-600', 'text-white', 'border-purple-600', 'ring-2', 'ring-purple-200');
