...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('orders')->name('customer.orders.')->group(function () {
        ...
        Route::post('/{order}/reorder', [App\Http\Controllers\Customer\OrderController::class, 'reorder'])->name('reorder');
        Route::get('/{order}/track', [App\Http\Controllers\Customer\OrderController::class, 'track'])->name('track');
    });

    // Legacy route for backward compatibility (redirect to the proper route)
