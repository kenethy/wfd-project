...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-8">
        <div class="flex flex-wrap gap-2">
            ...
            <a href="{{ route('customer.orders.index', ['status' => 'out_for_delivery']) }}"
                class="px-4 py-2 rounded-xl font-medium transition-colors duration-200 {{ request('status') === 'out_for_delivery' ? 'bg-purple-600 text-white' : 'bg-slate-100 text-slate-600 hover:bg-slate-200' }}">
        ...
        <div
            ...
            <div class="px-8 py-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                    ...
                    <div
                        class="flex items-center justify-center p-3 bg-slate-50 rounded-xl border-2 border-dashed border-slate-300">
